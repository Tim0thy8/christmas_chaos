...
public enum ModArmorMaterials implements ArmorMaterial {
    SET1("set1", 25, new int[] {3, 8, 6, 3}, 19, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 2f,
            0f, () -> Ingredient.ofItems(ModItems.SNOWMOD)),
    SANTA("santa", 25, new int[] {3, 9, 6, 3}, 19, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 2f,
            0f, () -> Ingredient.ofItems(ModItems.SNOWMOD))
    ;
    ...
    public String getName() {
        return ChristmasChaos.MOD_ID + ":" + this.name;
    }
